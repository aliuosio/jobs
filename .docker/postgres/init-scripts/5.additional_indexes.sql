...
-- Index for unapplied_idx (applied = false)
CREATE INDEX CONCURRENTLY IF NOT EXISTS job_offers_process_unapplied_idx 
ON public.job_offers_process (applied, job_offers_id) 
WHERE applied = false;